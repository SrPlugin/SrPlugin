...
<p align="left">
  ...
  <img src="https://skillicons.dev/icons?i=html,css,js,ts,tailwind,react,angular,nodejs,nest,sqlite,postgres,aws,docker,express,flutter,java,cpp,mongodb,mysql,nginx,sass,python,vite,tensorflow,bootstrap,astro,electron,cloudflare,aws,dart,go&perline=10" />
  </a>
</p>
<br>
